...
const translations = {
  en: {
    ...
    family: {
      title: "Parivar Room",
      subtitle: "The central hub for your family's Forever Connection.",
      recordings: "Recordings",
      storyMinutes: "Story Minutes",
      capsules: "Capsules",
      videoConnect: "Video Connect",
      minsMonthly: "Mins Monthly Included",
      usedThisMonth: "Used this month:",
      mins: "mins",
      startVideo: "Start Video Call",
      topUp: "Top-Up Minutes",
      pulsePortrait: "Pulse Portrait Audio",
      unlimitedAudio: "Unlimited Audio Calls",
      connectAudio: "Connect Audio",
      multiUser: "Multi-User Access",
      multiUserDesc: "Invite siblings, grandchildren, and extended family to view the vault and participate in calls.",
      upgradeMulti: "Upgrade for $9.99/mo",
      lifeBio: "Download Lifetime Biography",
      lifeBioDesc: "Receive a beautifully formatted PDF E-Book containing all transcribed stories, photos, and a complete downloadable Audio Vault ZIP file.",
      purchasePkg: "Purchase Package - $39",
      oneTime: "One-time fee",
      recentHistory: "Recent Connection History",
      noCalls: "No recent calls. Start a connection today!",
      supportMission: "Support Our Mission",
      supportDesc: "Help us provide free vaults to low-income families.",
      donate: "Donate $5",
      videoCall: "Video Call",
      chatTitle: "Ask Dada-Dadi",
      chatSubtitle: "Send a warm message — hear their voice respond.",
      chatPlaceholder: "Ask them something… e.g. What was your childhood like?",
      chatSend: "Send",
      chatGreeting: "Namaste, my dear. I am so happy you are here. What would you like to know about my life?",
      chatTyping: "Dada-Daji is typing…",
    },
  },
  es: {
    nav: {
    ...
    family: {
      title: "Sala Parivar",
      subtitle: "El centro de la Conexión Eterna de tu familia.",
      recordings: "Grabaciones",
      storyMinutes: "Minutos de Historia",
      capsules: "Cápsulas",
      videoConnect: "Video Conexión",
      minsMonthly: "Minutos Mensuales Incluidos",
      usedThisMonth: "Usado este mes:",
      mins: "mins",
      startVideo: "Iniciar Videollamada",
      topUp: "Recargar Minutos",
      pulsePortrait: "Audio Retrato Pulsante",
      unlimitedAudio: "Llamadas de Audio Ilimitadas",
      connectAudio: "Conectar Audio",
      multiUser: "Acceso Multi-Usuario",
      multiUserDesc: "Invita a hermanos, nietos y familia extendida a ver la bóveda y participar en llamadas.",
      upgradeMulti: "Mejorar por $9.99/mes",
      lifeBio: "Descargar Biografía de Vida",
      lifeBioDesc: "Recibe un PDF hermosamente formateado con todas las historias transcritas, fotos y un archivo ZIP de audio.",
      purchasePkg: "Comprar Paquete - $39",
      oneTime: "Pago único",
      recentHistory: "Historial de Conexiones Recientes",
      noCalls: "Sin llamadas recientes. ¡Empieza una conexión hoy!",
      supportMission: "Apoya Nuestra Misión",
      supportDesc: "Ayúdanos a dar bóvedas gratuitas a familias de bajos ingresos.",
      donate: "Donar $5",
      videoCall: "Videollamada",
      chatTitle: "Pregunta a Dada-Dadi",
      chatSubtitle: "Envía un mensaje cálido — escucha su voz responder.",
      chatPlaceholder: "Pregúntales algo… ej. ¿Cómo fue tu infancia?",
      chatSend: "Enviar",
      chatGreeting: "Namaste, mi querido/a. Estoy muy feliz de que estés aquí. ¿Qué quieres saber de mi vida?",
      chatTyping: "Dada-Daji está escribiendo…",
    },
  },
  hi: {
    nav: {
    ...
    family: {
      title: "परिवार कक्ष",
      subtitle: "आपके परिवार के हमेशा के जुड़ाव का केंद्र।",
      recordings: "रिकॉर्डिंग",
      storyMinutes: "कहानी मिनट",
      capsules: "कैप्सूल",
      videoConnect: "वीडियो कनेक्ट",
      minsMonthly: "मासिक मिनट शामिल",
      usedThisMonth: "इस महीने उपयोग:",
      mins: "मिनट",
      startVideo: "वीडियो कॉल शुरू करें",
      topUp: "मिनट टॉप-अप",
      pulsePortrait: "पल्स पोर्ट्रेट ऑडियो",
      unlimitedAudio: "असीमित ऑडियो कॉल",
      connectAudio: "ऑडियो से जुड़ें",
      multiUser: "बहु-उपयोगकर्ता पहुँच",
      multiUserDesc: "भाई-बहनों, पोते-पोतियों और परिवार को वॉल्ट देखने और कॉल में भाग लेने के लिए आमंत्रित करें।",
      upgradeMulti: "₹9.99/माह में अपग्रेड करें",
      lifeBio: "जीवन जीवनी डाउनलोड करें",
      lifeBioDesc: "सभी प्रतिलेखित कहानियों, फ़ोटो और ऑडियो ZIP के साथ एक सुंदर PDF E-Book प्राप्त करें।",
      purchasePkg: "पैकेज खरीदें - $39",
      oneTime: "एकमुश्त शुल्क",
      recentHistory: "हालिया कनेक्शन इतिहास",
      noCalls: "कोई हालिया कॉल नहीं। आज एक कनेक्शन शुरू करें!",
      supportMission: "हमारे मिशन का समर्थन करें",
      supportDesc: "कम आय वाले परिवारों को मुफ़्त वॉल्ट प्रदान करने में मदद करें।",
      donate: "$5 दान करें",
      videoCall: "वीडियो कॉल",
      chatTitle: "दादा-दादी से पूछें",
      chatSubtitle: "एक प्यारा संदेश भेजें — उनकी आवाज़ का जवाब सुनें।",
      chatPlaceholder: "उनसे कुछ पूछें… जैसे, आपका बचपन कैसा था?",
      chatSend: "भेजें",
      chatGreeting: "नमस्ते, मेरे प्यारे। मुझे बहुत खुशी है कि आप यहाँ हैं। आप मेरे जीवन के बारे में क्या जानना चाहते हैं?",
      chatTyping: "दादा-दादी टाइप कर रहे हैं…",
    },
  },
} as const;

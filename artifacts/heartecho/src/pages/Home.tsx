...
function GrandparentsHero() {
  return (
    <div className="w-full max-w-2xl mx-auto mb-14">
      <div
        className="w-full flex flex-col items-center justify-center py-16 px-8 relative overflow-hidden"
        style={{
          borderRadius: "24px",
          minHeight: "260px",
          background: "radial-gradient(ellipse 80% 70% at 50% 60%, #FDE68A 0%, #FCD34D 28%, #F59E0B 55%, #D97706 78%, #92400E 100%)",
          boxShadow: "0 8px 48px rgba(245,158,11,0.30), 0 2px 16px rgba(15,23,42,0.14)",
        }}
      >
        <div className="absolute inset-0 pointer-events-none flex items-center justify-center">
          <div className="w-[88%] h-[88%] rounded-full border border-white/15" />
          <div className="absolute w-[60%] h-[60%] rounded-full border border-white/20" />
        </div>
        <div className="relative z-10 text-center">
          <div className="text-7xl mb-5 leading-none select-none" role="img" aria-label="Grandparents">👴🏽👵🏽</div>
          <p className="font-serif text-xl md:text-2xl text-amber-950 font-semibold leading-snug max-w-md mx-auto">
            "Every voice preserved is a gift<br />that echoes through generations."
          </p>
        </div>
      </div>
    </div>
